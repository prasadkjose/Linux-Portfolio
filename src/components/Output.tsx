import About from "./terminal/commands/About";
import Clear from "./terminal/commands/Clear";
import Echo from "./terminal/commands/Echo";
import Education from "./terminal/commands/Education";
import Email from "./terminal/commands/Email";
import GeneralOutput from "./terminal/commands/GeneralOutput";
import Resume from "./terminal/commands/Resume";
import Help from "./terminal/commands/Help";
import Welcome from "./terminal/commands/Welcome";
import History from "./terminal/commands/History";
import Projects from "./terminal/commands/Projects";
import Socials from "./terminal/commands/Socials";
